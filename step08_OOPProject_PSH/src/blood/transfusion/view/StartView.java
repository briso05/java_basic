...
public class StartView {
	...
	public static void main(String[] args) {
		...
		System.out.println("수혈자 수정>>");
		controller.updateProject("A-", new Recipient("recipient5", "수혈5", 2, "F", "A-", "응급수술"));
		System.out.println("수정 확인>>");
		controller.projectView("A-");
		System.out.println();
		System.out.println("헌혈자 수정>>");
		controller.updateProject("A-", new Donor("donor5", "헌혈5", 26, "M", "A-", "봉사"));
		System.out.println("수정 확인>>");
		controller.projectView("A-");
		...
		System.out.println("===== 8. 존재하는 않는 프로젝트 삭제 - 예외처리 확인용 =====");
		controller.deleteProject("B--");
	}
